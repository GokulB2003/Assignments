...
Input Format The first line will contain TT, the number of test cases. Then the test cases follow. Each test case contains a single line of input, two integers XX and YY. Output Format For each test case, print text {YES} YES if it is possible for Ezio to manipulate all the guards. Otherwise, print text {NO} NO.
...
import java.util.*;
public class GuardManiPulate{
public static void main(String args[])
{
Scanner sc=new Scanner(System.in);
System.out.println("XX number of guards with the apple of Eden");
int xx=sc.nextInt();
System.out.println("Enter YY number of guards");
int yy=sc.nextInt();
if(xx>=1 && yy>=1)
{
if(yy<=xx)
